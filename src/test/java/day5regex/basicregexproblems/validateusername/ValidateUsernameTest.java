...
class ValidateUsernameTest {
    ...
    void testValidUsernames() {
        assertTrue(isValidUsername("Ashish123"), "Valid username failed");
    ...
    void testInvalidUsernames() {
        assertFalse(isValidUsername("123Ashish"), "Username starting with a number should be invalid");
        assertFalse(isValidUsername("as"), "Too short (less than 5 characters)");
